...
The diagram shows three columns of circles representing the sets X, Y, and Z. Column X is labeled 'médicos' and contains circles x1, x2, and x3. Column Y is labeled 'enfermeiros' and contains circles y1, y2, and y3. Column Z is labeled 'hospitais' and contains circles z1, z2, and z3. Three horizontal green lines connect the circles in a one-to-one correspondence: x1 to y1 to z1, x2 to y2 to z2, and x3 to y3 to z3.

Diagram illustrating a perfect matching between three sets: X (médicos), Y (enfermeiros), and Z (hospitais). Three horizontal lines connect x1 to y1 to z1, x2 to y2 to z2, and x3 to y3 to z3, showing a one-to-one correspondence.
...
<!-- Tipo: generico -->
> **[Descrição de imagem]** Diagram illustrating a perfect matching between three sets: X (médicos), Y (enfermeiros), and Z (hospitais).
<!-- /IMAGE_DESCRIPTION -->
## Definição (3-Dimensional Matching)
...
The diagram shows a central ring structure with four internal nodes labeled  $a_{11}$ ,  $a_{12}$ ,  $a_{13}$ , and  $a_{14}$ . These are connected by four triangles labeled  $t_{11}$ ,  $t_{12}$ ,  $t_{13}$ , and  $t_{14}$ . Each triangle has two external nodes:  $t_{11}$  connects  $a_{11}$  and  $a_{12}$  to  $b_{11}$  and  $b_{12}$ ;  $t_{12}$  connects  $a_{12}$  and  $a_{13}$  to  $b_{12}$  and  $b_{13}$ ;  $t_{13}$  connects  $a_{13}$  and  $a_{14}$  to  $b_{13}$  and  $b_{14}$ ; and  $t_{14}$  connects  $a_{14}$  and  $a_{11}$  to  $b_{14}$  and  $b_{11}$ .

Diagram of a variable gadget (ring) showing four internal nodes (a11, a12, a13, a14) and four external nodes (b11, b12, b13, b14) connected by four triangles (t11, t12, t13, t14).

The left diagram shows the variable gadget with internal nodes  $a_{11}$ ,  $a_{12}$ ,  $a_{13}$ , and  $a_{14}$  highlighted in green, representing a "Verdadeiro" (True) assignment. The right diagram shows the same gadget with internal nodes  $a_{11}$ ,  $a_{12}$ ,  $a_{13}$ , and  $a_{14}$  highlighted in orange, representing a "Falso" (False) assignment. In both diagrams, the external nodes  $b_{11}$ ,  $b_{12}$ ,  $b_{13}$ , and  $b_{14}$  are shown in blue circles, and the triangles  $t_{11}$ ,  $t_{12}$ ,  $t_{13}$ , and  $t_{14}$  are shown in gray.
...
<!-- Tipo: generico -->
> **[Descrição de imagem]** Diagram of a variable gadget (ring) showing four internal nodes (a11, a12, a13, a14) and four external nodes (b11, b12, b13, b14) connected by four triangles (t11, t12, t13, t14).
<!-- /IMAGE_DESCRIPTION -->
...
Cobrir os nós internos a obriga cada **anel** a escolher um único lado. Se foi o lado  $V$ , **definir**  $\alpha(x_i)=V$ ; senão  $\alpha(x_i)=F$ . Atribuição consistente, sem ambiguidade.
### 2 Verificar as cláusulas

Cada  $s_j$  foi coberto por uma tripla  $(s_j, \cdot, \text{literal})$ . Esse literal só estava livre se for verdadeiro segundo  $\alpha$  — logo  $C_j$  está satisfeita.
### 3 Conclusão

Como todo  $s_j$  é coberto, toda cláusula tem um literal verdadeiro. Portanto  $\alpha$  satisfaz  $\varphi$ .
...
4 A limpeza absorve os literais restantes  $\rightarrow$  matching perfeito ✓
